  ...
  const renderSourcesButton = () => {
    ...
    return (
      <div className="mt-6 pt-4 border-t border-gray-100">
                  ...
                  <TooltipComponent>
                    <TooltipTrigger asChild>
                      ...
                      >
                        ...
                        <SourceIcon 
                          className={`w-4 h-4 ${source.favicon ? 'hidden' : ''}`}
        ...
        {/* Summary with truncation and hover tooltip */}
        <TooltipProvider>
          <TooltipComponent>
            <TooltipTrigger asChild>
            ...
            <TooltipContent className="max-w-sm">
              <p className="text-xs font-medium mb-1">View complete source</p>
              <p className="text-xs">{selectedSource.dataSource}</p>
            </TooltipContent>
          </TooltipComponent>
        </TooltipProvider>
        ...
        <Button
          ...
          className="mt-2 text-xs text-blue-600 hover:text-blue-800 hover:bg-blue-50"
        >
