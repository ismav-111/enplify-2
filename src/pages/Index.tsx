...
import { Files, Settings, User, Search, Eye, Trash2, Plus } from 'lucide-react';
            ...
            {showFilesIcon && (
              <Popover>
                <PopoverTrigger asChild>
                  <Button variant="ghost" size="icon" className="h-9 w-9 rounded-full hover:bg-gray-100 relative transition-colors">
